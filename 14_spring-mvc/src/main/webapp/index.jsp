...
<body>
	...
	<a href="${pageContext.request.contextPath}/rest/resBody.do"> 
		rest 문자열 응답 
	</a><br />
	<a href="${pageContext.request.contextPath}/rest/resBody.json"> 
		rest JSON 응답
	</a><br />
	<a href="${pageContext.request.contextPath}/rest/resVOBody.json"> 
		rest JSON VO 응답
	</a><br />
	<a href="${pageContext.request.contextPath}/rest/resStringListBody.json">
	  	rest JSON List(문자열) 응답
	</a><br />
	<a href="${pageContext.request.contextPath}/rest/resVOListBody.json">
		rest JSON List(VO) 응답
	</a><br />	
	...
	<a href="${pageContext.request.contextPath}/path/memberInfo.do?id=a"> 
		PathVariable 파라미터 
	</a><br /> 
